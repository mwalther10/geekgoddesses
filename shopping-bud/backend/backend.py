...
def sample():
    ...
    if type == "eco_pasta":
        if "vegan" in filters and "gluten" in filters:
            product_keys = ["4864394070560", "5057172338696", "3445020177351", "0074305066054", "3083681081022",
                            "0011110845320"]
            ...
            product_keys = ["4864394070560", "5057172338696", "3445020177351", "8003566001001", "3083681081022",
                            "0011110845320"]
        ...
        if "vegan" in filters and "gluten" in filters:
            product_keys = ["4864394070560", "5057172477326", "8017596015549", "0074305066054", "20078621", "10022405"]
            prices = [2.08, 2.0, 19.90, 4.50, 6.35, 0.75]
        elif "vegan" in filters and "gluten" not in filters:
            product_keys = ["4864394070560", "5057172477326", "8017596015549", "0074305066054", "20078621", "10022405"]
            prices = [2.08, 2.0, 19.90, 4.50, 6.35, 0.75]
        elif "vegan" not in filters and "gluten" in filters:
            product_keys = ["4864394070560", "20717483", "8017596015549", "0074305066054", "20078621", "10022405"]
